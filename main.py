...
from leetcode.editor.en.Q2836.MaximizeValueOfFunctionInABallPassingGame import MaximizeValueOfFunctionInABallPassingGame
from leetcode.editor.en.Q403.FrogJump import FrogJump

dummy = Solution()
if __name__ == '__main__':
    print(MaximizeValueOfFunctionInABallPassingGame().getMaxFunctionValue(receiver=[1, 0], k=10000000000))