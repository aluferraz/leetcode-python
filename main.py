...
from leetcode.editor.en.Q296.BestMeetingPoint import BestMeetingPoint
from leetcode.editor.en.Q91.DecodeWays import DecodeWays

dummy = Solution()

if __name__ == '__main__':
    print(NumberOfDiceRollsWithTargetSum().numRollsToTarget(30, 30, 30))
