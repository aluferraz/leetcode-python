...
<strong>Explanation: </strong>After flips a = 1 , b = 4 , c = 5 such that (<span><code>a</code></span> OR <span><code>b</code></span> == <span><code>c</code></span>)</pre>
